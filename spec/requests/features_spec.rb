...
RSpec.describe "/features", type: :request do
  ...
  describe "GET /show" do
    it "renders a successful response" do
      ...
      get project_feature_url(project, feature)
      expect(response).to be_successful
    end
  end
  ...
  describe "GET /new" do
    it "renders a successful response" do
      get new_project_feature_url(project)
      expect(response).to be_successful
    end
  end
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Feature" do
        expect {
          post project_features_url(project), params: { feature: valid_attributes }
        }.to change(Feature, :count).by(1)
      end

      it "redirects to the created feature" do
        post project_features_url(project), params: { feature: valid_attributes }
        expect(response).to redirect_to(project_feature_url(project, project.features.last))
      end
    end
    ...
    context "with invalid parameters" do
      it "does not create a new Feature" do
        expect {
          post project_features_url(project), params: { feature: invalid_attributes }
